...
const _m = (id,tipo,pId,aId,cant,cu,ct,lote,fecha,motivo,doc,notas='') => ({
  id,tipo,productoId:pId,almacenId:aId,cantidad:cant,costoUnitario:cu,costoTotal:ct,
...
export const MOV = [
  ...
  _m('mv001','ENTRADA','prod1','alm1',10,2780,27800,'L-HP-0824','2024-08-15','Compra OC-001-0001','OC-001-0001'),
  _m('mv002','ENTRADA','prod2','alm1',6,470,2820,'L-LG-0924','2024-09-10','Compra OC-001-0002','OC-001-0002'),
  _m('mv003','ENTRADA','prod7','alm2',30,16.5,495,'L-STN-0924','2024-09-20','Compra OC-001-0003','OC-001-0003'),
  _m('mv004','ENTRADA','prod8','alm1',30,41,1230,'L-RES-1024','2024-10-01','Compra OC-001-0004','OC-001-0004'),
  _m('mv005','ENTRADA','prod21','alm2',15,29,435,'L-CAS-1024','2024-10-10','Compra OC-001-0005','OC-001-0005'),
  _m('mv006','ENTRADA','prod6','alm1',5,95,475,'L-STN-1024','2024-10-15','Compra OC-001-0006','OC-001-0006'),
  _m('mv007','ENTRADA','prod3','alm1',20,62,1240,'L-LOG-1024','2024-10-20','Compra OC-001-0007','OC-001-0007'),
  _m('mv008','ENTRADA','prod11','alm2',120,13.5,1620,'L-PAP-1024','2024-10-20','Compra OC-001-0008','OC-001-0008'),
  // Salidas Oct 2024
  _m('mv020','SALIDA','prod1','alm1',3,2780,8340,'','2024-10-25','Venta mayorista Corporación ABC','GR-001-0001'),
  _m('mv021','SALIDA','prod2','alm1',2,470,940,'','2024-10-28','Venta tienda tecnología','GR-001-0002'),
  _m('mv022','SALIDA','prod11','alm2',25,13.5,337.5,'','2024-10-30','Venta papelería','GR-001-0003'),
  _m('mv023','SALIDA','prod7','alm2',8,16.5,132,'','2024-10-31','Venta ferretería','GR-001-0004'),
  _m('mv024','SALIDA','prod3','alm1',6,62,372,'','2024-10-31','Venta periféricos','GR-001-0005'),
  // Nov 2024: entradas
  _m('mv030','ENTRADA','prod24','alm1',8,112,896,'L-OST-1124','2024-11-15','Compra OC-001-0009','OC-001-0009'),
  _m('mv031','ENTRADA','prod12','alm2',25,26,650,'L-FOL-1124','2024-11-05','Compra OC-001-0010','OC-001-0010'),
  _m('mv032','ENTRADA','prod9','alm1',60,7.2,432,'L-THI-1124','2024-11-10','Compra OC-001-0011','OC-001-0011'),
  _m('mv033','ENTRADA','prod15','alm1',30,10.5,315,'L-DET-1124','2024-11-20','Compra OC-001-0012','OC-001-0012'),
  _m('mv034','ENTRADA','prod19','alm3',18,55,990,'L-GLO-1124','2024-11-25','Compra OC-001-0013','OC-001-0013'),
  _m('mv035','ENTRADA','prod1','alm1',8,2850,22800,'L-HP-1124','2024-11-20','Compra OC-001-0020','OC-001-0020'),
  // Salidas Nov 2024
  _m('mv040','SALIDA','prod1','alm1',2,2780,5560,'','2024-11-05','Venta Nexus Solutions','GR-001-0006'),
  _m('mv041','SALIDA','prod8','alm1',8,41,328,'','2024-11-08','Venta resina','GR-001-0007'),
  _m('mv042','SALIDA','prod9','alm1',15,7.2,108,'','2024-11-12','Venta thinner','GR-001-0008'),
  _m('mv043','SALIDA','prod11','alm2',30,13.5,405,'','2024-11-15','Venta papel — Colegios Lima Norte','GR-001-0009'),
  _m('mv044','SALIDA','prod7','alm2',10,16.5,165,'','2024-11-18','Venta cintas métricas','GR-001-0010'),
  _m('mv045','SALIDA','prod24','alm1',2,112,224,'','2024-11-22','Venta licuadoras','GR-001-0011'),
  _m('mv046','SALIDA','prod3','alm1',5,62,310,'','2024-11-25','Venta combos teclado','GR-001-0012'),
  _m('mv047','SALIDA','prod15','alm1',8,10.5,84,'','2024-11-28','Venta desinfectante','GR-001-0013'),
  _m('mv048','SALIDA','prod19','alm3',4,55,220,'','2024-11-30','Venta leche Gloria','GR-001-0014'),
  // Dic 2024: entradas
  _m('mv050','ENTRADA','prod4','alm2',7,248,1736,'L-APC-1224','2024-12-05','Compra OC-001-0014','OC-001-0014'),
  _m('mv051','ENTRADA','prod13','alm1',8,118,944,'L-TON-1224','2024-12-10','Compra OC-001-0015','OC-001-0015'),
  _m('mv052','ENTRADA','prod10','alm2',50,11,550,'L-SIL-1224','2024-12-01','Compra OC-001-0016','OC-001-0016'),
  _m('mv053','ENTRADA','prod16','alm2',12,21,252,'L-JAB-1224','2024-12-20','Compra OC-001-0017','OC-001-0017'),
  _m('mv054','ENTRADA','prod22','alm2',20,32,640,'L-GUA-1224','2024-12-08','Compra OC-001-0018','OC-001-0018'),
  _m('mv055','ENTRADA','prod18','alm3',80,5.8,464,'L-ACE-1224','2024-12-15','Compra OC-001-0026','OC-001-0026'),
  // Salidas Dic 2024
  _m('mv060','SALIDA','prod1','alm1',2,2807,5614,'','2024-12-03','Venta Tecnología Lima','GR-001-0015'),
  _m('mv061','SALIDA','prod2','alm1',3,470,1410,'','2024-12-05','Venta monitores','GR-001-0016'),
  _m('mv062','SALIDA','prod8','alm1',10,41.6,416,'','2024-12-08','Venta resina epóxica','GR-001-0017'),
  _m('mv063','SALIDA','prod11','alm2',40,13.6,544,'','2024-12-10','Venta cierre año — Oficinas Corporativas','GR-001-0018'),
  _m('mv064','SALIDA','prod21','alm2',5,29,145,'','2024-12-12','Venta cascos EPP','GR-001-0019'),
  _m('mv065','SALIDA','prod24','alm1',3,114,342,'','2024-12-15','Venta licuadoras','GR-001-0020'),
  _m('mv066','SALIDA','prod9','alm1',20,7.3,146,'','2024-12-18','Venta thinner','GR-001-0021'),
  _m('mv067','SALIDA','prod10','alm2',15,11,165,'','2024-12-20','Venta silicona neutra','GR-001-0022'),
  _m('mv068','SALIDA','prod22','alm2',6,32,192,'','2024-12-22','Venta guantes nitrilo','GR-001-0023'),
  _m('mv069','SALIDA','prod13','alm1',3,118,354,'','2024-12-27','Venta tóner HP','GR-001-0024'),
  // Ajuste fin de año
  _m('mv070','AJUSTE','prod14','alm1',50,8.5,425,'','2024-12-28','[- AJUSTE] Faltante en conteo físico','AJ-001-0001','Inventario cierre 2024'),
  // Ene 2025: entradas
  _m('mv080','ENTRADA','prod2','alm1',5,488,2440,'L-LG-0125','2025-01-08','Compra OC-001-0021','OC-001-0021'),
  _m('mv081','ENTRADA','prod11','alm2',90,14,1260,'L-PAP-0125','2025-01-15','Compra OC-001-0022','OC-001-0022'),
  _m('mv082','ENTRADA','prod21','alm2',7,30,210,'L-CAS-0125','2025-01-22','Compra OC-001-0023','OC-001-0023'),
  _m('mv083','ENTRADA','prod23','alm2',8,88,704,'L-ZAP-0125','2025-01-18','Compra OC-001-0024','OC-001-0024'),
  _m('mv084','ENTRADA','prod19','alm3',10,57,570,'L-GLO-0125','2025-01-30','Compra OC-001-0025','OC-001-0025'),
  _m('mv085','ENTRADA','prod17','alm3',20,118,2360,'L-AZU-0125','2025-01-10','Compra OC-001-0019','OC-001-0019'),
  _m('mv086','ENTRADA','prod20','alm3',30,148,4440,'L-ARR-0125','2025-01-05','Compra OC-001-0027','OC-001-0027'),
  _m('mv087','ENTRADA','prod6','alm1',4,98,392,'L-STN-0125','2025-01-12','Compra OC-001-0028','OC-001-0028'),
  _m('mv088','ENTRADA','prod3','alm1',3,62,186,'L-LOG-0125','2025-01-20','Compra OC-001-0041','OC-001-0041'),
  // Salidas Ene 2025
  _m('mv090','SALIDA','prod1','alm1',1,2812,2812,'','2025-01-06','Venta Municipalidad','GR-002-0001'),
  _m('mv091','SALIDA','prod11','alm2',35,13.7,479.5,'','2025-01-08','Venta papel oficina','GR-002-0002'),
  _m('mv092','SALIDA','prod8','alm1',7,42.1,294.7,'','2025-01-10','Venta resina','GR-002-0003'),
  _m('mv093','SALIDA','prod18','alm3',20,5.8,116,'','2025-01-12','Venta aceite — Mayorista El Huerto','GR-002-0004'),
  _m('mv094','SALIDA','prod20','alm3',8,148,1184,'','2025-01-15','Venta arroz','GR-002-0005'),
  _m('mv095','SALIDA','prod17','alm3',5,118.8,594,'','2025-01-18','Venta azúcar','GR-002-0006'),
  _m('mv096','SALIDA','prod9','alm1',12,7.2,86.4,'','2025-01-20','Venta thinner','GR-002-0007'),
  _m('mv097','SALIDA','prod15','alm1',10,10.7,107,'','2025-01-22','Venta desinfectante','GR-002-0008'),
  _m('mv098','SALIDA','prod21','alm2',3,29.4,88.2,'','2025-01-25','Venta cascos — Const. Horizonte','GR-002-0009'),
  _m('mv099','SALIDA','prod22','alm2',4,32.2,128.8,'','2025-01-28','Venta guantes','GR-002-0010'),
  _m('mv100','SALIDA','prod7','alm2',12,16.6,199.2,'','2025-01-29','Venta cintas métricas','GR-002-0011'),
  _m('mv101','SALIDA','prod24','alm1',2,114.5,229,'','2025-01-30','Venta licuadoras','GR-002-0012'),
  // Feb 2025: entradas
  _m('mv110','ENTRADA','prod5','alm1',6,178,1068,'L-BSH-0225','2025-02-10','Compra OC-001-0029','OC-001-0029'),
  _m('mv111','ENTRADA','prod8','alm1',25,43,1075,'L-RES-0125','2025-01-20','Compra OC-001-0030','OC-001-0030'),
  _m('mv112','ENTRADA','prod12','alm2',13,27,351,'L-FOL-0225','2025-02-08','Compra OC-001-0031','OC-001-0031'),
  _m('mv113','ENTRADA','prod9','alm1',60,7.5,450,'L-THI-0225','2025-02-15','Compra OC-001-0032','OC-001-0032'),
  _m('mv114','ENTRADA','prod15','alm1',26,11,286,'L-DET-0225','2025-02-10','Compra OC-001-0033','OC-001-0033'),
  _m('mv115','ENTRADA','prod10','alm2',38,11.5,437,'L-SIL-0225','2025-02-20','Compra OC-001-0034','OC-001-0034'),
  _m('mv116','ENTRADA','prod22','alm2',11,33,363,'L-GUA-0225','2025-02-18','Compra OC-001-0035','OC-001-0035'),
  _m('mv117','ENTRADA','prod18','alm3',64,6.0,384,'L-ACE-0225','2025-02-05','Compra OC-001-0036','OC-001-0036'),
  _m('mv118','ENTRADA','prod20','alm3',20,152,3040,'L-ARR-0225','2025-02-25','Compra OC-001-0037','OC-001-0037'),
  _m('mv119','ENTRADA','prod17','alm3',15,120,1800,'L-AZU-0225','2025-02-20','Compra OC-001-0038','OC-001-0038'),
  _m('mv120','ENTRADA','prod13','alm1',6,122,732,'L-TON-0225','2025-02-25','Compra OC-001-0039','OC-001-0039'),
  _m('mv121','ENTRADA','prod8','alm1',13,44,572,'L-RES-0325','2025-03-05','Compra OC-001-0040','OC-001-0040'),
  _m('mv122','ENTRADA','prod7','alm2',15,17,255,'L-STN-0225','2025-02-01','Compra OC-001-0042','OC-001-0042'),
  _m('mv123','ENTRADA','prod24','alm1',5,118,590,'L-OST-0225','2025-02-12','Compra OC-001-0043','OC-001-0043'),
  // Salidas Feb 2025
  _m('mv130','SALIDA','prod8','alm1',9,42.5,382.5,'','2025-02-03','Venta resina','GR-002-0013'),
  _m('mv131','SALIDA','prod11','alm2',40,13.8,552,'','2025-02-05','Venta papel — Copy Center','GR-002-0014'),
  _m('mv132','SALIDA','prod18','alm3',25,5.9,147.5,'','2025-02-07','Venta aceite','GR-002-0015'),
  _m('mv133','SALIDA','prod1','alm1',2,2815,5630,'','2025-02-10','Venta laptops','GR-002-0016'),
  _m('mv134','SALIDA','prod20','alm3',10,149.5,1495,'','2025-02-12','Venta arroz — Bodega San Martín','GR-002-0017'),
  _m('mv135','SALIDA','prod9','alm1',18,7.3,131.4,'','2025-02-14','Venta thinner','GR-002-0018'),
  _m('mv136','SALIDA','prod17','alm3',8,119.3,954.4,'','2025-02-15','Venta azúcar','GR-002-0019'),
  _m('mv137','SALIDA','prod7','alm2',14,16.7,233.8,'','2025-02-17','Venta cintas métricas','GR-002-0020'),
  _m('mv138','SALIDA','prod21','alm2',4,29.3,117.2,'','2025-02-18','Venta cascos EPP — Const. Horizonte','GR-002-0021'),
  _m('mv139','SALIDA','prod2','alm1',2,478.5,957,'','2025-02-20','Venta monitores','GR-002-0022'),
  _m('mv140','SALIDA','prod10','alm2',20,11.2,224,'','2025-02-22','Venta silicona','GR-002-0023'),
  _m('mv141','SALIDA','prod15','alm1',12,10.8,129.6,'','2025-02-24','Venta desinfectante','GR-002-0024'),
  _m('mv142','SALIDA','prod22','alm2',5,32.4,162,'','2025-02-25','Venta guantes nitrilo','GR-002-0025'),
  _m('mv143','SALIDA','prod12','alm2',8,26.4,211.2,'','2025-02-27','Venta folders manila','GR-002-0026'),
  _m('mv144','SALIDA','prod5','alm1',2,178,356,'','2025-02-28','Venta taladros Bosch','GR-002-0027'),
  // Transferencias Feb 2025
  _m('mv150','TRANSFERENCIA','prod11','alm2',20,13.8,276,'','2025-02-20','[TRANSFER OUT → alm1] Rebalanceo','TR-001-0001'),
  _m('mv151','TRANSFERENCIA','prod11','alm1',20,13.8,276,'','2025-02-20','[TRANSFER IN ← alm2] Rebalanceo','TR-001-0001'),
  // Devolución
  _m('mv160','ENTRADA','prod8','alm1',2,42.5,85,'','2025-03-05','[DEV CLIENTE] Error en pedido','DEV-001-0001'),
  // Mar 2025
  _m('mv170','SALIDA','prod8','alm1',5,43,215,'','2025-03-10','Venta resina epóxica','GR-003-0001'),
  _m('mv171','SALIDA','prod18','alm3',18,5.95,107.1,'','2025-03-10','Venta aceite — Distribuidor Norte','GR-003-0002'),
  _m('mv172','SALIDA','prod11','alm2',25,13.8,345,'','2025-03-11','Venta papel bond','GR-003-0003'),
  _m('mv173','SALIDA','prod20','alm3',12,150,1800,'','2025-03-12','Venta arroz Paisana','GR-003-0004'),
  _m('mv174','SALIDA','prod9','alm1',15,7.4,111,'','2025-03-12','Venta thinner','GR-003-0005'),
  _m('mv175','SALIDA','prod15','alm1',6,10.8,64.8,'','2025-03-13','Venta desinfectante','GR-003-0006'),
]
...
export const DESPACHOS_DEMO = [
  {id:'des1',numero:'GD-001-0001',estado:'ENTREGADO', clienteId:'cli1',almacenId:'alm1',fecha:'2025-01-10',fechaEntrega:'2025-01-12',fechaDespacho:'2025-01-12',items:[{productoId:'prod1',cantidad:2,costoUnitario:2815,precioVenta:3450,subtotal:6900},{productoId:'prod2',cantidad:3,precioVenta:720,costoUnitario:478.5,subtotal:2160}],subtotal:9060,igv:1630.8,total:10690.8,guiaNumero:'GR-001-0001',direccionEntrega:'Av. Javier Prado 1520, San Isidro',transportista:'Courier Lima Express',observaciones:'Entregado conforme',usuarioId:'usr2',createdAt:'2025-01-10T09:00:00Z'},
  {id:'des2',numero:'GD-001-0002',estado:'ENTREGADO', clienteId:'cli3',almacenId:'alm2',fecha:'2025-01-08',fechaEntrega:'2025-01-09',fechaDespacho:'2025-01-09',items:[{productoId:'prod11',cantidad:35,costoUnitario:13.7,precioVenta:22,subtotal:770}],subtotal:770,igv:138.6,total:908.6,guiaNumero:'GR-002-0002',direccionEntrega:'Av. Universitaria 3400, Los Olivos',transportista:'Unidad propia',observaciones:'',usuarioId:'usr2',createdAt:'2025-01-08T08:00:00Z'},
  {id:'des3',numero:'GD-001-0003',estado:'DESPACHADO',clienteId:'cli2',almacenId:'alm1',fecha:'2025-03-13',fechaEntrega:'2025-03-15',fechaDespacho:'2025-03-14',items:[{productoId:'prod8',cantidad:5,costoUnitario:43,precioVenta:78,subtotal:390},{productoId:'prod10',cantidad:20,costoUnitario:11.2,precioVenta:18,subtotal:360}],subtotal:750,igv:135,total:885,guiaNumero:'GR-003-0001',direccionEntrega:'Av. Larco 1301, Miraflores',transportista:'Courier Lima Express',observaciones:'En ruta',usuarioId:'usr1',createdAt:'2025-03-13T10:00:00Z'},
  {id:'des4',numero:'GD-001-0004',estado:'LISTO',     clienteId:'cli5',almacenId:'alm1',fecha:'2025-03-14',fechaEntrega:'2025-03-16',fechaDespacho:null,items:[{productoId:'prod21',cantidad:5,costoUnitario:29.3,precioVenta:48,subtotal:240},{productoId:'prod22',cantidad:3,costoUnitario:32.4,precioVenta:52,subtotal:156}],subtotal:396,igv:71.28,total:467.28,guiaNumero:null,direccionEntrega:'Av. Carlos Izaguirre 176, Los Olivos, Lima',transportista:'Unidad propia',observaciones:'Esperando transportista',usuarioId:'usr2',createdAt:'2025-03-14T08:00:00Z'},
  {id:'des5',numero:'GD-001-0005',estado:'PICKING',   clienteId:'cli7',almacenId:'alm3',fecha:'2025-03-15',fechaEntrega:'2025-03-17',fechaDespacho:null,items:[{productoId:'prod18',cantidad:20,costoUnitario:5.95,precioVenta:8.9,subtotal:178},{productoId:'prod20',cantidad:5,costoUnitario:150,precioVenta:198,subtotal:990},{productoId:'prod17',cantidad:3,costoUnitario:119.3,precioVenta:155,subtotal:465}],subtotal:1633,igv:293.94,total:1926.94,guiaNumero:null,direccionEntrega:'Av. Tupac Amaru 1200, Comas, Lima',transportista:'Por asignar',observaciones:'Preparando en almacén frío',usuarioId:'usr2',createdAt:'2025-03-15T07:30:00Z'},
  {id:'des6',numero:'GD-001-0006',estado:'APROBADO',  clienteId:'cli4',almacenId:'alm1',fecha:'2025-03-15',fechaEntrega:'2025-03-18',fechaDespacho:null,items:[{productoId:'prod1',cantidad:1,costoUnitario:2812,precioVenta:3450,subtotal:3450},{productoId:'prod4',cantidad:2,costoUnitario:248,precioVenta:380,subtotal:760}],subtotal:4210,igv:757.8,total:4967.8,guiaNumero:null,direccionEntrega:'Jirón Lampa 585, Lima',transportista:'Por asignar',observaciones:'Cliente solicita entrega urgente',usuarioId:'usr1',createdAt:'2025-03-15T09:00:00Z'},
  {id:'des7',numero:'GD-001-0007',estado:'PEDIDO',    clienteId:'cli6',almacenId:'alm2',fecha:'2025-03-15',fechaEntrega:'2025-03-20',fechaDespacho:null,items:[{productoId:'prod7',cantidad:10,costoUnitario:16.7,precioVenta:28,subtotal:280},{productoId:'prod11',cantidad:20,costoUnitario:13.8,precioVenta:22,subtotal:440}],subtotal:720,igv:129.6,total:849.6,guiaNumero:null,direccionEntrega:'Av. Arica 420, Breña, Lima',transportista:'Por asignar',observaciones:'',usuarioId:'usr3',createdAt:'2025-03-15T11:00:00Z'},
]

export const TRANSPORTISTAS_DEMO = [
...
export const RUTAS_DEMO = [
  {id:'rut1',numero:'RT-001-0001',estado:'COMPLETADA',transportistaId:'tra1',fechaSalida:'2025-01-12',horaSalida:'08:00',fechaRetorno:'2025-01-12',horaRetorno:'14:30',despachoIds:['des1','des2'],paradas:[{despachoId:'des1',orden:1,estado:'ENTREGADO',horaLlegada:'09:15',horaPartida:'09:45',observacion:'Entregado conforme'},{despachoId:'des2',orden:2,estado:'ENTREGADO',horaLlegada:'11:00',horaPartida:'11:20',observacion:''}],kmRecorrido:85,costoViaje:120,observaciones:'Ruta completada sin novedades',usuarioId:'usr1',createdAt:'2025-01-11T16:00:00Z'},
  {id:'rut2',numero:'RT-001-0002',estado:'EN_RUTA',   transportistaId:'tra3',fechaSalida:'2025-03-14',horaSalida:'09:00',fechaRetorno:null,horaRetorno:null,despachoIds:['des3'],paradas:[{despachoId:'des3',orden:1,estado:'EN_CAMINO',horaLlegada:null,horaPartida:null,observacion:''}],kmRecorrido:0,costoViaje:45,observaciones:'',usuarioId:'usr2',createdAt:'2025-03-14T08:30:00Z'},
  {id:'rut3',numero:'RT-001-0003',estado:'PROGRAMADA',transportistaId:'tra1',fechaSalida:'2025-03-16',horaSalida:'07:30',fechaRetorno:null,horaRetorno:null,despachoIds:['des4','des6'],paradas:[{despachoId:'des4',orden:1,estado:'PENDIENTE',horaLlegada:null,horaPartida:null,observacion:''},{despachoId:'des6',orden:2,estado:'PENDIENTE',horaLlegada:null,horaPartida:null,observacion:''}],kmRecorrido:0,costoViaje:80,observaciones:'Prioridad: cliente Municipalidad',usuarioId:'usr1',createdAt:'2025-03-15T15:00:00Z'},
  {id:'rut4',numero:'RT-001-0004',estado:'PROGRAMADA',transportistaId:'tra2',fechaSalida:'2025-03-17',horaSalida:'08:00',fechaRetorno:null,horaRetorno:null,despachoIds:['des5','des7'],paradas:[{despachoId:'des5',orden:1,estado:'PENDIENTE',horaLlegada:null,horaPartida:null,observacion:''},{despachoId:'des7',orden:2,estado:'PENDIENTE',horaLlegada:null,horaPartida:null,observacion:''}],kmRecorrido:0,costoViaje:65,observaciones:'',usuarioId:'usr2',createdAt:'2025-03-15T16:00:00Z'},
]

export const CXC_DEMO = [
