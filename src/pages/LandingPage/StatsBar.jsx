export function StatsBar({ primary, stats }) {
  // Sin métricas reales configuradas todavía (SuperAdmin → Landing Page →
  // Métricas) — se oculta la sección entera en vez de mostrar cifras
  // inventadas ("500+ empresas activas", etc. — auditoría 2026-09-16).
  ...
  return (
    <section className="border-y border-white/8 bg-[#111820] py-10">
      <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map(s => (
          <div key={s.id || s.label} className="flex flex-col items-center text-center p-5 rounded-2xl bg-white/3 border border-white/7">
