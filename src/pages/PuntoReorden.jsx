...
export default function PuntoReorden() {
  ...
  }, [productos, movimientosRaw, ordenes, categorias])
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-6 flex flex-col gap-5">
      ...
      <div className="bg-[#161d28] border border-white/8 rounded-xl p-5">
        ...
        <div className="overflow-x-auto rounded-xl border border-white/8">
          <table className="w-full border-collapse text-[13px]">
            ...
            <tbody>
              ...
              {filtered.map(p => (
                <tr key={p.id} className={`border-b border-white/6 last:border-0 transition-colors ${
                  p.stockActual <= 0 ? 'bg-red-500/4' :
                  p.necesitaPedido   ? 'bg-amber-500/3' : 'hover:bg-white/2'
                }`}>
        ...
        <div className="bg-[#161d28] border border-[#00c896]/20 rounded-xl p-5 mt-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#5f6f80] leading-relaxed">
                ...
                en el módulo de Inventario para que los cálculos sean precisos.
              </p>
            </div>
          </div>
        </div>
