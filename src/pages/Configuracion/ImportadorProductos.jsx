...
// ImportadorMaestro, que va contra el endpoint transaccional del backend.
export default function ImportadorProductos({ cats, alms, provs, prods, crearProducto, actualizarProducto, toast }) {
