...
import { Plus, Search, RotateCcw, ArrowDownToLine, ArrowUpFromLine, Eye, Trash2 } from 'lucide-react'
...
export default function Devoluciones() {
  const { devoluciones, productos, almacenes, proveedores, sesion, recargarProductos, recargarMovimientos, recargarDevoluciones, toast, formulaValorizacion, simboloMoneda } = useApp()
  ...
  const filtered = useMemo(() => {
    ...
    return d
  }, [devoluciones, filtTipo, busqueda, productos])
    ...
    <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
      ...
      <div className="bg-[#161d28] border border-white/[0.08] rounded-xl p-5">
        <div className="flex items-center justify-between mb-4">
          <span className="text-[11px] font-semibold text-[#5f6f80] uppercase tracking-[0.06em]">Historial de Devoluciones</span>
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          ...
          <select className={SEL} style={{width:180}} value={filtTipo} onChange={e => setFiltTipo(e.target.value)}>
        ...
        <div className="overflow-x-auto rounded-xl border border-white/[0.08]">
          <table className="w-full border-collapse text-[13px]">
            <thead><tr>
              {['Fecha','Documento','Tipo','Producto','Cantidad','Estado ítem','Motivo','Impacto','Acciones'].map(h => (
