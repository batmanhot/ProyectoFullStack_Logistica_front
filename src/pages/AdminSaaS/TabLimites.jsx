...
export default function TabLimites({ planes, actualizarPlan, toast }) {
  ...
  const MODULOS = [
    ...
    { key:'despachos',   label:'Despachos',                desc:'Clientes, despachos, pedidos internos, empaque' },
    { key:'transporte',  label:'Transporte',                desc:'Rutas, flota y mantenimiento' },
    { key:'ventas',      label:'Ventas',                    desc:'Proformas, cuentas por cobrar, portal de pedidos' },
