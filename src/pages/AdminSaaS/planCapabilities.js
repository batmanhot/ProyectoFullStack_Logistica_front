...
export const PLAN_PRESETS = [
  { id:'evaluacion', nombre:'Prueba guiada', targetPlanId:'trial', targetPlanName:'Prueba gratuita', description:'Validación acotada antes de contratar.', values:{ maxUsuarios:2, maxProductos:50, maxAlmacenes:1, maxProveedores:5, maxClientes:10, maxOrdenesMes:20, modulosIncluidos:['inventario','operaciones','despachos'] } },
  { id:'micro', nombre:'Microempresa', targetPlanId:'basico', targetPlanName:'Básico', description:'Operación esencial para equipos de 1–2 personas.', values:{ maxUsuarios:2, maxProductos:50, maxAlmacenes:1, maxProveedores:10, maxClientes:30, maxOrdenesMes:50, modulosIncluidos:['inventario','operaciones','despachos'] } },
  { id:'pequena', nombre:'Pequeña empresa', targetPlanId:'basico', targetPlanName:'Básico', description:'Más capacidad e incorporación de compras.', values:{ maxUsuarios:5, maxProductos:500, maxAlmacenes:2, maxProveedores:50, maxClientes:150, maxOrdenesMes:300, modulosIncluidos:['inventario','operaciones','compras','despachos'] } },
  { id:'crecimiento', nombre:'En crecimiento', targetPlanId:'profesional', targetPlanName:'Profesional', description:'Operación integral, transporte y analítica.', values:{ maxUsuarios:20, maxProductos:5000, maxAlmacenes:5, maxProveedores:250, maxClientes:1500, maxOrdenesMes:3000, modulosIncluidos:['inventario','operaciones','compras','despachos','transporte','reportes','panel-auditoria'] } },
  { id:'corporativo', nombre:'Corporativo', targetPlanId:'empresarial', targetPlanName:'Empresarial', description:'Escala ilimitada y cobertura funcional completa.', values:{ maxUsuarios:-1, maxProductos:-1, maxAlmacenes:-1, maxProveedores:-1, maxClientes:-1, maxOrdenesMes:-1, modulosIncluidos:PLAN_MODULES.map(module => module.key) } },
]
