...
// ═══════════════════════════════════════════════════════════
const _m=(id,tipo,pId,aId,cant,cu,ct,lote,fecha,motivo,doc,notas='')=>({id,tipo,productoId:pId,almacenId:aId,cantidad:cant,costoUnitario:cu,costoTotal:ct,lote,fecha,motivo,documento:doc,notas,usuarioId:'usr1',createdAt:`${fecha}T10:00:00Z`})
